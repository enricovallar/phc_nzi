(set! num-bands 9)
(set! resolution 32)
(set! k-points (list (vector3 0.1 0.0 0.0) (vector3 0.0 0.0 0.0) (vector3 0.08660254037844388 0.049999999999999996 0.0)))
(set! k-points (interpolate 60 k-points))
(define-param h 1e+20)
(define-param r1 0.19090909090909092)
(define-param r2 0.11496198157796257)
...
(set! geometry (list 
 (make block (size (vector3 1 1 h))
  ...
  (material (make dielectric (epsilon 9.610000000000001))))
