...
(run-te (output-at-kpoint (vector3 0 0 0) fix-efield-phase output-efield output-hfield))
(run-tm (output-at-kpoint (vector3 0 0 0) fix-efield-phase output-efield output-hfield))