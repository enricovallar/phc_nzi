...
(run-zeven (output-at-kpoint (vector3 0 0 0) fix-efield-phase output-efield output-hfield))
(run-zodd (output-at-kpoint (vector3 0 0 0) fix-efield-phase output-efield output-hfield))